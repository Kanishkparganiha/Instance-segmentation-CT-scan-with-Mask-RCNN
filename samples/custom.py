...
get_ipython().system('python3 custom.py train --dataset=/home/kanishka/data_science/PythonCode/Mask_RCNN/tensorflow2/Mask_RCNN/samples/custom/dataset --weights=coco')
